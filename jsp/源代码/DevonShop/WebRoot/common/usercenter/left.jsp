...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function userInfoUpdate(){
			window.top.frames[1].location.href = "<%=path%>/servlet/UpdateUserHelperServlet?userName=${sessionScope.commonUser.userName}&userType=${sessionScope.commonUser.type}";
		}
		
		function pswUpdate(){
			window.top.frames[1].location.href = "<%=path%>/updpsw/updpsw.jsp?type=2&userName=${sessionScope.commonUser.userName}";
		}
  ...
  <br>
  		<table border="0" align="center">
  			<tr>
  				<td width="160px" height="31px" style="cursor: hand;" background="<%=path %>/common/usercenter/images/show_basic_info.jpg" onclick="showBasicInfo()"></td>
  			</tr>
  			<tr>
  				<td height="10px"></td>
  			</tr>
  			<tr>
  				<td width="160px" height="31px" style="cursor: hand;" background="<%=path %>/common/usercenter/images/user_info_update.jpg" onclick="userInfoUpdate()"></td>
  			</tr>
  			 <tr>
  				<td height="10px"></td>
  			</tr>
  			<tr>
  				<td width="160px" height="31px" style="cursor: hand;" background="<%=path %>/common/usercenter/images/psw_update.jpg" onclick="pswUpdate()"></td>
  			</tr>
  			<tr>
  				<td height="10px"></td>
  			</tr>
