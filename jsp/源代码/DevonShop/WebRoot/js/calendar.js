...
function td_click(t_object){
  ...
  if (parseInt(t_object.innerHTML,10)>=1 && parseInt(t_object.innerHTML,10)<=31 ){
    ...
    if (t_d<=date_end && t_d>=date_start){
      ...
      checkInputValue(document.getElementById("birthday").value, document.getElementById("spanBirthday"), '出生日期', '注册用户必须大于10周岁！', /^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)$/, document.getElementById("path").value);
    }
  }
}
