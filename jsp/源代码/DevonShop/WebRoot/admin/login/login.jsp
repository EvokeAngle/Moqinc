...
-->
				...
				<td width="195" background="Images/login_2.gif">
					<table width="190" height="106" border="0" align="center"
						...
						<form method="post" action="<%=path%>/servlet/AdminLoginServlet"
							...
							<tr>
								...
								<td>
									<input name="userName" type="TEXT" value="${cookie.userNameAdmin.value }"
							...
							<tr>
								...
								<td>
									...
									<input type="text" id="checkCode" class="code"
										style="height: 20px; width: 55px; font-family: serif" />
